...
"}\n"
"\n"
"QPushButton#rightPage"
                        "MonthlyExpenses, QPushButton#leftPageMonthlyExpenses\n"
"{\n"
"	background-color: transparent;\n"
"	border-radius: 0px;\n"
"	border-color: transparent;\n"
...
"{\n"
"    image: url(:/images/im"
                        "ages/arrow_drop_down_white_18dp_hover.svg);\n"
"}\n"
"\n"
"QDateEdit\n"
"{\n"
...
"QDateEdit::drop-down \n"
"{\n"
"    image: url(:/images/images/today-whi"
                        "te-24dp.svg);\n"
"    width: 18px;\n"
"    height: 18px;\n"
"	padding-right: 2px;\n"
...
"{\n"
"	qproperty-"
                        "icon: url(:/images/images/chevron_left-white-18dp.svg);\n"
"}\n"
"\n"
...
"	border: 1px solid transparent;\n"
"	borde"
                        "r-bottom: 1px solid rgba(1, 144, 234, 200);\n"
"	border-radius: 4px;\n"
"	padding-top: 2px;\n"
"	padding-bottom: 2px;\n"
"	padding-left: 7px;\n"
...
"}\n"
"\n"
"QDateEdit#dateEdit_income_from, QDateEdit#dateEdit_income_to, QDateEdit#dateEdit_expenses_from, QDateEdit#dateEdit_expenses_to \n"
"{\n"
"	border: 1px solid transparent;\n"
"	border-bottom: 1px solid rgba(255, 255, 255, 200);\n"
"	border-radius: 4px;\n"
...
"{\n"
"	bac"
                        "kground-color: rgba(2, 113, 184, 0);\n"
"	border: 1px solid;\n"
"	border-radius: 28px;\n"
"	border-color: transparent;\n"
"	padding-left: 0px;\n"
...
" }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionDashboard.setText(QCoreApplication.translate("MainWindow", "Dashboard", None))
#if QT_CONFIG(tooltip)
        self.actionDashboard.setToolTip(QCoreApplication.translate("MainWindow", "Dashboard", None))
#endif // QT_CONFIG(tooltip)
        self.actionMenu.setText(QCoreApplication.translate("MainWindow", "Menu", None))
#if QT_CONFIG(tooltip)
        self.actionMenu.setToolTip(QCoreApplication.translate("MainWindow", "Menu", None))
#endif // QT_CONFIG(tooltip)
        self.actionGraph.setText(QCoreApplication.translate("MainWindow", "Graph", None))
#if QT_CONFIG(tooltip)
        self.actionGraph.setToolTip(QCoreApplication.translate("MainWindow", "Graphs", None))
#endif // QT_CONFIG(tooltip)
        self.actionInsights.setText(QCoreApplication.translate("MainWindow", "Insights", None))
#if QT_CONFIG(tooltip)
        self.actionInsights.setToolTip(QCoreApplication.translate("MainWindow", "Insights", None))
#endif // QT_CONFIG(tooltip)
        self.menuLabel.setText(QCoreApplication.translate("MainWindow", "Dashboard", None))
#if QT_CONFIG(tooltip)
        self.alerts.setToolTip(QCoreApplication.translate("MainWindow", "Notifications", None))
#endif // QT_CONFIG(tooltip)
        self.alerts.setText("")
#if QT_CONFIG(tooltip)
        self.settings.setToolTip(QCoreApplication.translate("MainWindow", "Settings", None))
#endif // QT_CONFIG(tooltip)
        self.settings.setText("")
        self.transactions.setWindowTitle(QCoreApplication.translate("MainWindow", "Transactions", None))
        self.accounts.setWindowTitle(QCoreApplication.translate("MainWindow", "Balance", None))
        self.spending.setWindowTitle(QCoreApplication.translate("MainWindow", "Spending", None))
        self.savings.setWindowTitle(QCoreApplication.translate("MainWindow", "Shortcuts", None))
        self.monthlyExpenses.setWindowTitle(QCoreApplication.translate("MainWindow", "Expenses Distribution", None))
        self.expenses.setWindowTitle(QCoreApplication.translate("MainWindow", "Expenses", None))
        self.toolButton_icon_category_2.setText(QCoreApplication.translate("MainWindow", "...", None))
        self.expenses_choice.setItemText(0, QCoreApplication.translate("MainWindow", "All", None))
        self.expenses_choice.setItemText(1, QCoreApplication.translate("MainWindow", "Restaurants", None))
        self.expenses_choice.setItemText(2, QCoreApplication.translate("MainWindow", "Gas", None))

        self.dateEdit_expenses_from.setDisplayFormat(QCoreApplication.translate("MainWindow", "MMMM-yyyy", None))
        self.label_from_income_2.setText(QCoreApplication.translate("MainWindow", "From:", None))
        self.dateEdit_expenses_to.setDisplayFormat(QCoreApplication.translate("MainWindow", "MMMM-yyyy", None))
#if QT_CONFIG(tooltip)
        self.refresh_expenses.setToolTip(QCoreApplication.translate("MainWindow", "Refresh graph", None))
#endif // QT_CONFIG(tooltip)
        self.label_3.setText(QCoreApplication.translate("MainWindow", "To:", None))
        self.this_year_expenses.setText(QCoreApplication.translate("MainWindow", "This year ", None))
        self.last_12_months_expenses.setText(QCoreApplication.translate("MainWindow", "Last 12 months", None))
        self.previous_year_expenses.setText(QCoreApplication.translate("MainWindow", "Previous year", None))
        self.check_labels_expenses.setText(QCoreApplication.translate("MainWindow", "Show labels", None))
        self.check_average_expenses.setText(QCoreApplication.translate("MainWindow", "Show average", None))
        self.check_total_expenses.setText(QCoreApplication.translate("MainWindow", "Show total amount", None))
        self.income.setWindowTitle(QCoreApplication.translate("MainWindow", "Income", None))
        self.toolButton_icon_category.setText(QCoreApplication.translate("MainWindow", "...", None))
        self.income_choice.setItemText(0, QCoreApplication.translate("MainWindow", "All", None))
        self.income_choice.setItemText(1, QCoreApplication.translate("MainWindow", "Wages", None))
        self.income_choice.setItemText(2, QCoreApplication.translate("MainWindow", "Gifts", None))

        self.label_from_income.setText(QCoreApplication.translate("MainWindow", "From:", None))
        self.dateEdit_income_from.setDisplayFormat(QCoreApplication.translate("MainWindow", "MMMM-yyyy", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", "To:", None))
        self.dateEdit_income_to.setDisplayFormat(QCoreApplication.translate("MainWindow", "MMMM-yyyy", None))
#if QT_CONFIG(tooltip)
        self.refresh_income.setToolTip(QCoreApplication.translate("MainWindow", "Refresh graph", None))
#endif // QT_CONFIG(tooltip)
        self.this_year_income.setText(QCoreApplication.translate("MainWindow", "This year ", None))
        self.last_12_months_income.setText(QCoreApplication.translate("MainWindow", "Last 12 months", None))
        self.previous_year_income.setText(QCoreApplication.translate("MainWindow", "Previous year", None))
        self.check_labels_income.setText(QCoreApplication.translate("MainWindow", "Show labels", None))
        self.check_average_income.setText(QCoreApplication.translate("MainWindow", "Show average", None))
        self.check_total_income.setText(QCoreApplication.translate("MainWindow", "Show total amount", None))
