...
class Ui_ColorPicker(object):
    ...
    def retranslateUi(self, ColorPicker):
        ColorPicker.setWindowTitle(QCoreApplication.translate(b"ColorPicker", "Form", None))
        # if QT_CONFIG(tooltip)
        self.color_2.setToolTip(QCoreApplication.translate(b"ColorPicker", "#6658ca", None))
        # endif // QT_CONFIG(tooltip)
        self.color_2.setText("")
        self.label.setText(QCoreApplication.translate(b"ColorPicker", "Basic Colors", None))
        # if QT_CONFIG(tooltip)
        self.color_3.setToolTip(QCoreApplication.translate(b"ColorPicker", "#0054c7", None))
        # endif // QT_CONFIG(tooltip)
        self.color_3.setText("")
        # if QT_CONFIG(tooltip)
        self.color_4.setToolTip(QCoreApplication.translate(b"ColorPicker", "#26c1ca", None))
        # endif // QT_CONFIG(tooltip)
        self.color_4.setText("")
        # if QT_CONFIG(tooltip)
        self.color_1.setToolTip(QCoreApplication.translate(b"ColorPicker", "#1ba9e9", None))
        # endif // QT_CONFIG(tooltip)
        self.color_1.setText("")
        # if QT_CONFIG(tooltip)
        self.color_5.setToolTip(QCoreApplication.translate(b"ColorPicker", "#fccb01", None))
        # endif // QT_CONFIG(tooltip)
