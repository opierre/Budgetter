...
class AccountDelegate(QItemDelegate):
    ...
    def paint(
        ...
        painter.setBrush(QColor("transparent"))
        rect_svg = QRect(
            rect_icon.x(), rect_icon.y() + 5, rect_icon.width(), rect_icon.height() - 10
        )
        ...
        # Set category on top
        rect_category = QRect(
            rect_icon.x() + rect_icon.width() + option.rect.width() * 1 / 30,
        ...
        if trend == "UP":
            ...
            svg_renderer = QSvgRenderer(
                ":/images/images/arrow_right_alt_FILL0_wght400_GRAD0_opsz48.svg"
            )
